...
This repo contains a [setup script](https://github.com/zenati/sd-ui-cf/blob/master/setup.sh) that can be run on an EC2 instance as a one-click deployment.

Steps:
1. Clone this repo via 
```
git clone https://github.com/zenati/sd-ui-cf.git
```
